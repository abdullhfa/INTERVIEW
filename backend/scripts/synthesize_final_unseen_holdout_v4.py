"""
Synthesize the Final Unseen Holdout v4 audio.
...
faster-whisper.
    ...
    python scripts/synthesize_final_unseen_holdout_v4.py
    python scripts/synthesize_final_unseen_holdout_v4.py --only fuh4_007 --force
...
def main() -> int:
    ...
    if not scripts_path.is_file():
        print(f"missing {scripts_path} — run build_final_unseen_holdout_v4_scripts.py first")
        return 1
    ...
    print("next: python scripts/lock_holdout_v4.py --write")
