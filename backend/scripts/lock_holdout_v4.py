"""
Lock (and later verify) the Final Unseen Holdout v4 pack.

    python scripts/lock_holdout_v4.py --write    # once, after synthesis
    python scripts/lock_holdout_v4.py            # verify nothing moved
